...
best_hyper_parameters = [1250, 0.75, 0.65, 1, 25]
            ...
            with tf.Session() as s:
                ...
                if show_analysis:
                    ...
                    for digit in range(0, 9 + 1):
                        ax.plot(points_2d[test_lbls == digit, 0], points_2d[test_lbls == digit, 1], linestyle='',
                                marker='o', markersize=5, label=str(digit))
                    ax.legend()
                    fig.show()
...
forest_minimize(task1, [skopt.space.Integer(25, 1500),
