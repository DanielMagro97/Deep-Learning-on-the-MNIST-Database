...
best_hyper_parameters = [300, 2, 100, 0.75, 'AdamOptimizer', 'GRU', "-1and1"]
...
def task2(hyper_parameters):
    ...
    patience = 50#hyper_parameters[7]

    # Choose whether the image should be represent as 0s and 1s (0and1) or -1s and 1s (-1and1)
    image_representation = hyper_parameters[6]
...
forest_minimize(task2, [skopt.space.Integer(25, 750),
                ...
                x0=[300, 2, 100, 0.75, 'AdamOptimizer', 'GRU', "-1and1"])