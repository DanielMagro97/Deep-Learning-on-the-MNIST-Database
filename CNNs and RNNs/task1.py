...
with graph.as_default():
    ...
    W = tf.get_variable('W', [conv_width, conv_height, 1, conv_layer_size], tf.float32, tf.random_normal_initializer(stddev=0.01))
